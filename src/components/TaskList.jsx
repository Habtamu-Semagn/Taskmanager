...
function displayCompleted(taskList, displayBtn, setDisplayBtn) {
  const completed = taskList.filter((task) => task.completed === true).length;
  const totalTasks = taskList.length;
  if ((completed === totalTasks) & (displayBtn !== false)) setDisplayBtn(false);
  else if (completed !== totalTasks && displayBtn !== true) setDisplayBtn(true);
}
function TaskList() {
